...
export const CardOne = () => {
  return (
    <div className="relative duration-300 hover:-rotate-0 -rotate-12 group border border-sky-900 border-4 overflow-hidden rounded-2xl h-52 w-72 bg-sky-800 p-5 flex flex-col items-start gap-4">
    ...
    <div className="card">
      <div className="relative bg-black w-[300px] sm:w-[350px] group transition-all duration-700 aspect-video flex items-center justify-center">
        <div className="transition-all flex flex-col items-center py-5 justify-start duration-300 group-hover:duration-1000 bg-white w-full h-full absolute group-hover:-translate-y-16">
          ...
          <p className="font-sans text-[10px] text-gray-700 pt-5">Bima Jovanta</p>
        </div>
      ...
      <div className="w-[180px] aspect-square relative z-20 after:absolute after:h-1 after:w-full after:opacity-0 after:bg-[#7b956a] after:top-8 after:left-0 after:group-hover:opacity-100 after:translate-x-1/2 after:translate-y-1/2 after:-z-20 after:group-hover:w-full after:transition-all after:duration-300 after:group-hover:origin-right after:group-hover:-translate-x-1/2 group-hover:translate-x-1/2 transition-all duration-300">
        <svg xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" textRendering="geometricPrecision" shapeRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd">
          <linearGradient y2={0} y1={512} x2={256} x1={256} gradientUnits="userSpaceOnUse" id="id0">
            <stop stopColor="#495c48" offset={0} />
            <stop stopColor="#9db891" offset=".490196" />
            <stop stopColor="#7b956a" offset={1} />
          </linearGradient>
          <g id="Layer_x0020_1">
        ...
        <div className="tooltips absolute top-0 left-0 -translate-x-[150%] p-2 flex flex-col items-start gap-10 transition-all duration-300 group-hover:-translate-x-full">
          ...
          <ul className="flex flex-col items-start gap-2">
            <li className="inline-flex gap-2 items-center justify-center group-hover:delay-200 transition-all opacity-0 group-hover:opacity-100 group-hover:transition-all group-hover:duration-500">
              <svg strokeLinejoin="round" strokeLinecap="round" strokeWidth={3} className="stroke-[#495c48]" stroke="#000000" fill="none" viewBox="0 0 24 24" height={10} width={10} xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="inline-flex gap-2 items-center justify-center group-hover:delay-400 transition-all opacity-0 group-hover:opacity-100 group-hover:transition-all group-hover:duration-500">
              ...
              <p className="text-xs font-semibold text-[#495c48]">Reduce Winkles</p>
            </li>
  ...
  return (
    <div className="group before:hover:scale-95 before:hover:h-72 before:hover:w-80 before:hover:h-44 before:hover:rounded-b-2xl before:transition-all before:duration-500 before:content-[''] before:w-80 before:h-24 before:rounded-t-2xl before:bg-gradient-to-bl from-sky-200 via-orange-200 to-orange-700 before:absolute before:top-0 w-80 h-72 relative bg-slate-50 flex flex-col items-center justify-center gap-2 text-center rounded-2xl overflow-hidden">
      ...
      <div className="z-10 group-hover:-translate-y-10 transition-all duration-500">
        <span className="text-2xl font-semibold">Bima Jovanta</span>
      ...
      <div className="main">
        <div className="card">
          <svg fillRule="nonzero" height="30px" width="30px" viewBox="0,0,256,256" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" className="instagram">
            <g style={{ mixBlendMode: 'normal' }} textAnchor="none" fontSize="none" fontWeight="none" fontFamily="none" strokeDashoffset={0} strokeDasharray={1} strokeMiterlimit={10} strokeLinejoin="miter" strokeLinecap="butt" strokeWidth={1} stroke="none" fillRule="nonzero">
        ...
        <div className="card">
          <img src="https://ui.bimadev.xyz/favicon.ico" alt="Logo BimsUI" className='uiverse' />
        </div>
        <div className="card">
          ...
          <svg version="1.1" id="svg2" width="666.66669" height="666.66669" viewBox="0 0 666.66669 666.66669" xmlns="http://www.w3.org/2000/svg">
            <defs id="defs6">
              <clipPath clipPathUnits="userSpaceOnUse" id="clipPath408">
                <path d="m 699.926,0 h 3600.16 V 4818.31 H 699.926 Z" id="path406" />
              </clipPath>
            </defs>
            <g id="g8" transform="matrix(1.3333333,0,0,-1.3333333,0,666.66667)">
              <g id="g10" transform="scale(0.1)">
                <path d="M 0,0 H 5000 V 5000 H 0 Z" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path12" />
                <path d="M 0,1126.2 H 4487.25 V 5000 H 0 Z" style={{ fill: '#fef0ef', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path14" />
                <path d="M 5000,561.691 4487.25,1126.2 V 5000 H 5000 V 561.691" style={{ fill: '#fde4e1', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path16" />
                <path d="M 4487.25,1146.2 5000,590.422 V 530.859 L 4487.25,1106.22 0,1106.2 v 40 h 4487.25" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path18" />
                <path d="m 914.891,2652.86 h 2369.21 V 4428.88 H 914.891 Z" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path20" />
                <path d="m 995.844,2713.15 h 2207.3 v 1655.44 h -2207.3 z" style={{ fill: '#fdeae9', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path22" />
                <path d="M 2914.29,4139.24 H 1284.71 v 127.31 h 1629.58 v -127.31" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path24" />
                <path d="m 1349.04,2921.58 h -126.83 v 318.43 h 126.83 v -318.43" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path26" />
                <path d="m 1634.86,3519.55 h -126.83 v -597.97 h 126.83 v 597.97" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path28" />
                <path d="m 1920.68,3457.72 h -126.84 v -536.14 h 126.84 v 536.14" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path30" />
                <path d="m 2079.66,2921.58 h 126.828 v 838.84 H 2079.66 Z" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path32" />
                <path d="M 2699.39,2833.93 H 1138.44 v 1154 h 17.32 V 2851.25 h 1543.63 v -17.32" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path34" />
                <path d="m 1278.36,3412.46 -11.56,12.89 296.95,266.64 275.05,-59.75 297.83,331.57 12.89,-11.57 -304.57,-339.06 -276.22,60 -290.37,-260.72" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path36" />
                <path d="m 2172.85,3903.25 -83.98,80.53 108.42,29.01 z" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path38" />
                <path d="m 3051.89,3946.91 h -579.93 v 22.73 h 579.93 v -22.73" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path40" />
                <path d="m 3051.89,3891.89 h -658.23 v 22.72 h 658.23 v -22.72" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path42" />
                <path d="m 3051.89,3836.86 h -658.23 v 22.73 h 658.23 v -22.73" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path44" />
                <path d="m 3051.89,3781.84 h -658.23 v 22.72 h 658.23 v -22.72" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path46" />
                <path d="m 3051.89,3726.81 h -658.23 v 22.73 h 658.23 v -22.73" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path48" />
                <path d="m 3051.89,3671.78 h -658.23 v 22.73 h 658.23 v -22.73" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path50" />
                <path d="m 3051.89,3616.76 h -658.23 v 22.72 h 658.23 v -22.72" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path52" />
                <path d="m 3051.89,3561.73 h -658.23 v 22.73 h 658.23 v -22.73" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path54" />
                <path d="m 3051.89,3506.7 h -658.23 v 22.73 h 658.23 v -22.73" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path56" />
                <path d="m 2393.66,3451.68 h 658.23 v 22.7188 h -658.23 z" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path58" />
                <path d="m 2393.66,3396.65 h 658.23 v 22.7227 h -658.23 z" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path60" />
                <path d="m 3051.89,3341.62 h -658.23 v 22.73 h 658.23 v -22.73" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path62" />
                <path d="m 3051.89,3286.6 h -658.23 v 22.72 h 658.23 v -22.72" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path64" />
                <path d="m 3051.89,3231.57 h -658.23 v 22.73 h 658.23 v -22.73" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path66" />
                <path d="m 3051.89,3176.54 h -658.23 v 22.73 h 658.23 v -22.73" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path68" />
                <path d="m 3051.89,3121.52 h -658.23 v 22.72 h 658.23 v -22.72" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path70" />
                <path d="m 3051.89,3066.49 h -658.23 v 22.72 h 658.23 v -22.72" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path72" />
                <path d="m 3051.89,3011.46 h -658.23 v 22.72 h 658.23 v -22.72" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path74" />
                <path d="m 3051.89,2956.44 h -289.96 v 22.72 h 289.96 v -22.72" style={{ fill: '#fff8f6', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path76" />
                <path d="m 3661.18,4380.23 c -149.67,0 -271.42,-121.76 -271.42,-271.42 0,-149.66 121.75,-271.42 271.42,-271.42 149.66,0 271.42,121.76 271.42,271.42 0,149.66 -121.76,271.42 -271.42,271.42 z m 0,-574.43 c -167.08,0 -303.02,135.93 -303.02,303.01 0,167.08 135.94,303.01 303.02,303.01 167.08,0 303.01,-135.93 303.01,-303.01 0,-167.08 -135.93,-303.01 -303.01,-303.01" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path78" />
                <path d="m 3846.4,4108.81 v 0 c 0,8.44 6.9,15.34 15.35,15.34 h 26.3 c 8.43,0 15.34,-6.9 15.34,-15.34 0,-8.44 -6.91,-15.34 -15.34,-15.34 h -26.3 c -8.45,0 -15.35,6.9 -15.35,15.34" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path80" />
                <path d="m 3418.96,4108.81 v 0 c 0,8.44 6.91,15.34 15.36,15.34 h 26.3 c 8.43,0 15.34,-6.9 15.34,-15.34 0,-8.44 -6.91,-15.34 -15.34,-15.34 h -26.3 c -8.45,0 -15.36,6.9 -15.36,15.34" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path82" />
                <path d="m 3661.18,3923.59 v 0 c 8.44,0 15.34,-6.91 15.34,-15.34 v -26.31 c 0,-8.43 -6.9,-15.34 -15.34,-15.34 -8.44,0 -15.34,6.91 -15.34,15.34 v 26.31 c 0,8.43 6.9,15.34 15.34,15.34" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path84" />
                <path d="m 3661.18,4351.02 v 0 c 8.44,0 15.34,-6.9 15.34,-15.34 v -26.3 c 0,-8.45 -6.9,-15.35 -15.34,-15.35 -8.44,0 -15.34,6.9 -15.34,15.35 v 26.3 c 0,8.44 6.9,15.34 15.34,15.34" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path86" />
                <path d="m 3530.21,3977.84 v 0 c 5.97,-5.97 5.97,-15.74 0,-21.7 l -18.6,-18.6 c -5.97,-5.97 -15.73,-5.97 -21.7,0 -5.96,5.97 -5.96,15.73 0,21.7 l 18.61,18.6 c 5.96,5.97 15.72,5.97 21.69,0" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path88" />
                <path d="m 3832.45,4280.08 v 0 c 5.97,-5.97 5.97,-15.73 0,-21.7 l -18.6,-18.6 c -5.97,-5.97 -15.73,-5.97 -21.7,0 -5.97,5.97 -5.97,15.73 0,21.7 l 18.6,18.6 c 5.97,5.97 15.73,5.97 21.7,0" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path90" />
                <path d="m 3530.21,4239.78 v 0 c -5.97,-5.97 -15.73,-5.97 -21.69,0 l -18.61,18.6 c -5.96,5.97 -5.96,15.73 0,21.7 5.97,5.97 15.73,5.97 21.7,0 l 18.6,-18.6 c 5.97,-5.97 5.97,-15.73 0,-21.7" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path92" />
                <path d="m 3832.45,3937.54 v 0 c -5.97,-5.97 -15.73,-5.97 -21.7,0 l -18.6,18.6 c -5.97,5.96 -5.97,15.73 0,21.7 5.97,5.97 15.73,5.97 21.7,0 l 18.6,-18.6 c 5.97,-5.97 5.97,-15.73 0,-21.7" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path94" />
                <path d="m 3686.25,4108.81 c 0,-13.85 -11.22,-25.07 -25.07,-25.07 -13.85,0 -25.07,11.22 -25.07,25.07 0,13.84 11.22,25.07 25.07,25.07 13.85,0 25.07,-11.23 25.07,-25.07" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path96" />
                <path d="m 3661.18,4140.21 v 0 c -2.68,0 -4.87,2.18 -4.87,4.87 v 128.11 c 0,2.69 2.19,4.87 4.87,4.87 2.69,0 4.87,-2.18 4.87,-4.87 v -128.11 c 0,-2.69 -2.18,-4.87 -4.87,-4.87" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path98" />
                <path d="m 3695.75,4108.81 v 0 c 0,2.69 2.18,4.87 4.87,4.87 h 84.62 c 2.69,0 4.87,-2.18 4.87,-4.87 0,-2.69 -2.18,-4.87 -4.87,-4.87 h -84.62 c -2.69,0 -4.87,2.18 -4.87,4.87" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path100" />
                <path d="m 2811.08,1683.91 h -78.68 v 281.2 h 78.68 v -281.2" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path102" />
                <path d="m 2734.9,1686.41 h 73.68 v 276.2 h -73.68 z m 78.68,-5 h -83.68 v 286.2 h 83.68 v -286.2" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path104" />
                <path d="m 2790.73,1756.66 h -37.98 v 178.52 h 37.98 v -178.52" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path106" />
                <path d="m 2757.74,1761.66 h 28 v 168.53 h -28 z m 37.98,-9.99 h -47.97 v 188.51 h 47.97 v -188.51" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path108" />
                <path d="m 2968.46,1683.91 h -78.68 v 281.2 h 78.68 v -281.2" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path110" />
                <path d="m 2892.27,1686.41 h 73.69 v 276.2 h -73.69 z m 78.69,-5 h -83.68 v 286.2 h 83.68 v -286.2" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path112" />
                <path d="m 2948.11,1756.66 h -37.98 v 178.52 h 37.98 v -178.52" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path114" />
                <path d="m 2915.12,1761.66 h 27.99 v 168.53 h -27.99 z m 37.98,-9.99 h -47.96 v 188.51 h 47.96 v -188.51" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path116" />
                <path d="m 2889.78,1683.91 h -78.7 v 281.2 h 78.7 v -281.2" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path118" />
                <path d="m 2869.41,1756.66 h -37.97 v 178.52 h 37.97 v -178.52" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path120" />
                <path d="m 1071.52,2645.58 c 6.16,10.04 33.79,32.89 40.36,42.67 18.94,28.26 52.01,77.18 82.18,97.67 9.51,6.46 40.24,10.88 43.61,5.2 4.02,-6.77 -11.83,-7.71 -26.78,-14 -8.95,-3.76 -11.3,-13.34 -15.68,-19.31 9.07,-2.61 16.3,-6.1 12.79,-14.85 11.28,-1.69 15.53,-7.56 13.48,-18.77 22.62,-5.78 -13.1,-41.1 -21.58,-48.72 -5.52,-4.96 -11.55,-9.71 -18.69,-11.72 -7.15,-2.03 -24.27,-3.38 -29.15,2.21 -16.16,-11.71 -39.82,-43.31 -39.82,-43.31" style={{ fill: '#fcd0ce', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }} id="path122" />
