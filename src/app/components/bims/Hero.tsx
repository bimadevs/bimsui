  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div className="hero-content cosmos-content">
        <h1 ref={titleRef} className="hero-title text-red-500">
          BimsUI
        </h1>
        
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line">
            BimsUI adalah library UI Gratis untuk semua
          </p>
          <p className="subtitle-line">
            Membuat website mu menjadi lebih modern dan interaktif
          </p>
        </div>
      </div>
      ...
      <div ref={scrollProgressRef} className="scroll-progress" style={{ visibility: 'hidden' }}>
        {/* Cosmic Button */}
        <Link href="/components" className="cosmic-button-container mt-12 mb-6">
          <button className="cosmic-button group relative">
            <span className="cosmic-button-content">Explore Components</span>
            <div className="cosmic-button-glow"></div>
            <div className="cosmic-button-particles">
              {[...Array(20)].map((_, i) => (
      ...
      <div className="scroll-sections">
       {[...Array(2)].map((_, i) => {
          ...
          const subtitles = {
            0: {
              line1: 'BimsUI adalah library UI Gratis untuk semua',
              line2: 'Membuat website mu menjadi lebih modern dan interaktif'
            },
            1: {
              line1: 'Tidak perlu membayar untuk UI Components',
              line2: 'BimsUI adalah library UI Gratis untuk semua'
            },
            2: {
              line1: 'Hemat waktu mu dalam membuat website',
              line2: 'Mudah diintegrasikan dengan website mu'
            }
          };
