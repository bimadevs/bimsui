...
export default function TooltioViewNextjs() {
    ...
    const dependencies = `npm i styled-components`
...
export default Loader;`
    const code6 = `import React from 'react';
import styled from 'styled-components';
...
export default Loader;`
    const code7 = `import React from 'react';
import styled from 'styled-components';
...
export default Loader;`
    ...
    const judul = "Loaders"
    const deskripsi = "A cool loaders with React and CSS"
                    ...
                    <div className={`transition-all  duration-300 ${sidebarOpen ? 'ml-64' : 'ml-0'}`}>
                        <div className="px-2 md:px-10">
                            ...
                            <div className="mt-4 ">
                                ...
                                <CodeBlock
                                    language="tsx"
                                    filename="/components/ui/loaders.tsx"
                                    code={code1}
                                />
                            </div>
