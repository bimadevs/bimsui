...
import { BtnSahara, BtnSvg } from "@/app/components/html/button/button";
...
export default function Button() {
  ...
  const btnsvg = `<button class="border text-gray-50  duration-300 relative group cursor-pointer   overflow-hidden h-16 w-48 rounded-md bg-neutral-800 p-2  font-extrabold hover:bg-sky-700">
        ...
        <main className="pt-20 flex-1 w-[100vw]">
          <div className={`transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-0'}`}>
            <div className="p-6">
              ...
              <div className="max-w-4xl grid grid-cols-2 justify-center items-center gap-8  border-dashed border-2 p-32 mt-4 mx-auto">
                <BtnSahara />
                <BtnSvg />
              </div>
              ...
              <div className="mt-6 "> {/* Menyesuaikan lebar secara dinamis */}
                ...
                <div className="mt-4 ">
                  ...
                  {/* utils code  */}
                  <h1 className="font-bold text-2xl">All Code use HTML</h1>
                  <p className="">Button Sahara</p>
                  <div className="relative mb-8">
                    <SyntaxHighlighter
                    ...
                    <CopyIcon id="btnsahara" code={btnsahara} />
                  ...
                  <p className="font-bold">Button SVG</p>
                  <div className="relative mb-8">
                    <SyntaxHighlighter
                      showLineNumbers={true}
                      wrapLines={true}
                    ...
                    <CopyIcon id="btnsvg" code={btnsvg} />
