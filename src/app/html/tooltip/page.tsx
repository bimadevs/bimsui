...
export default function TooltioView() {
    ...
    const html1 = `<div class="tooltip-container">
  <div class="tooltip">
    <div class="profile">
      <div class="user">
        <div class="img">Ui</div>
        <div class="details">
          <div class="name">Bimadev</div>
          <div class="username">@biimaa_jo</div>
        </div>
      </div>
      <div class="about">1k+ Followers</div>
    </div>
  </div>
  <div class="text">
    <a class="icon" href="#">
...
.about {
  ...
  padding-top: 5px;
    ...
    const html2 = `<div class="tooltip-container">
  <span class="text">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="22"
...
/* end tooltip facebook */

/* start tooltip whatsApp */
.tooltip3 {
  position: absolute;
  top: 100%;
  left: 60%;
...
/* end tooltip whatsApp */

/* start tooltip Discord */
.tooltip4 {
  position: absolute;
  top: 100%;
  left: -190%;
...
/* end tooltip pinterest */

/* start tooltip dribbble */
.tooltip6 {
  position: absolute;
  top: 100%;
  left: 35%;
...
/* end tooltip dribbble */

/* start tooltip github */
.tooltip7 {
  position: absolute;
  top: 100%;
  left: 39%;
...
/* end tooltip fixo */`
    const html3 = `<div class="item-hints">
...
.item-hints .hint[data-position="4"] .hint-content {
  ...
  margin-left: 56px;
    ...
    const html4 = `<div class="relative group inline-block">
  <div
  ...
  >
    ...
    const judul = "Tooltip"
    const deskripsi = "A cool tooltip with html and css or tailwind"
