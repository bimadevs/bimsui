...
.fil0 {
  ...
  const html3 = `<div class="light-button">
  <button class="bt">
  ...
  const css3 = `.light-button button.bt {
  position: relative;
  height: 200px;
  display: flex;
...
@keyframes rightArrow8 {
  ...
  const judul = "Button"
  const deskripsi = "A cool button with html and css or tailwind"
      ...
      <div className="flex">
        ...
        <main className="pt-20 flex-1 w-[100vw] ">
          <div className={`transition-all  duration-300 ${sidebarOpen ? 'ml-64' : 'ml-0'}`}>
            <div className="px-2 md:px-10 p-6">
