...
import { ButtonFour, ButtonOne, ButtonThree, ButtonTwo } from "@/app/components/html/button";
import { TooltipFour, TooltipOne, TooltipThree, TooltipTwo } from "@/app/components/html/tooltip";
import { LoaderEight, LoaderFive, LoaderFour, LoaderOne, LoaderSeven, LoaderSix, LoaderThree, LoaderTwo } from "@/app/components/html/loaders";

export default function TooltioView() {
...
@keyframes spin_4991 {
  ...
  100% {
    ...
    const html2 = `<div class="container">
...
@keyframes roadAnimation {
  ...
  100% {
    ...
    const html5 = `<div class="typewriter">
    <div class="slide"><i></i></div>
    <div class="paper"></div>
    <div class="keyboard"></div>
</div>`
    const css5 = `.typewriter {
  --blue: #5C86FF;
  --blue-dark: #275EFE;
  --key: #fff;
  --paper: #EEF0FD;
...
@keyframes pushInOut2724 {
  ...
  50%, to {
    ...
    const html8 = `<div class="loader-square"></div>
...
<div class="loader-square"></div>
    ...
    const css8 = `@keyframes square-animation {
 0% {
  left: 0;
  top: 0;
 }
...
.loader-square:nth-of-type(7) {
 animation-delay: -10s;
    ...
    const judul = "Loaders"
    const deskripsi = "A cool loaders with html and css or tailwind"
                ...
                <main className="pt-20 flex-1 w-[100vw] ">
                    <div className={`transition-all  duration-300 ${sidebarOpen ? 'ml-64' : 'ml-0'}`}>
                        <div className="px-2 md:px-10">
                            ...
                            <div className="relative border-dashed border-2 p-20 mt-10 flex justify-center items-center">
                                <LoaderTwo />
                            </div>
                            <div className="mt-4 ">
                                {/* Loader 2 */}
                            ...
                            <div className="mt-4 ">
                                ...
                                <CodeBlock
                                    ...
                                    filename="DummyComponent.jsx"
                                    tabs={[
                                        { name: "index.html", code: html3, language: "html" },
                                        {
                                            name: "style.css",
                                            code: css3,
                                            language: "css",
                            ...
                            <div className="mt-4 ">
                                ...
                                <CodeBlock
                                    ...
                                    filename="DummyComponent.jsx"
                                    tabs={[
                                        { name: "index.html", code: html4, language: "html" },
                                        {
                                            name: "style.css",
                                            code: css4,
                                            language: "css",
                            ...
                            <div className=" border-dashed border-2 p-8 mt-10 flex justify-center items-center">
                                <LoaderSix />
                            </div>
                            <div className="mt-4 ">
                                {/* Loader 6 */}
